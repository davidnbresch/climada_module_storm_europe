...
%
%   First trials for flood (needs isimip module and data), run:
%   entity=climada_entity_load % load a ClimateWise entity
%   hazard=isimip_flood_load_orig('global_FL.nc','auto',entity);
%   entity=climada_assets_encode(entity,hazard);
%   EDS=climada_EDS_calc(entity,hazard);figure;climada_EDS_DFC(EDS)
%   see e.g. hazards/GBR_UnitedKingdom_FL_ClimateWise (for all UK ptfs)
% CALLING SEQUENCE:
%   climatewise_run
% EXAMPLE:
%   climatewise_run

...
%   scp -r dbresch@euler.ethz.ch:/cluster/work/climate/dbresch/climada_data/hazards/WISC*.mat Documents/_GIT/climada_data/hazards/.
%   scp -r dbresch@euler.ethz.ch:/cluster/work/climate/dbresch/climada_data/results/WISC*.mat Documents/_GIT/climada_data/results/.
%   copy results back polybox: 
%   scp -r dbresch@euler.ethz.ch:/cluster/work/climate/dbresch/climada_data/hazards/WISC_eur_WS*.mat /Users/bresch/polybox/WISC/hazards/.
%   scp -r dbresch@euler.ethz.ch:/cluster/work/climate/dbresch/climada_data/results/WISC_eur_WS*.mat /Users/bresch/polybox/WISC/results/.
%
% CALLING SEQUENCE:
...
parfor loop_i=1:2 % a bit a joke, but at least parallel
    ...
    if loop_i==1
        ...
        hazard_set_file=[climada_global_hazards_dir filesep 'WISC_era20c_eur_WS.mat'];
    else
        wisc_file=[wisc_dir filesep 'fp_eraint_*.nc'];
        hazard_set_file=[climada_global_hazards_dir filesep 'WISC_eraint_eur_WS.mat'];
    end
    
    if ~exist(hazard_set_file,'file')
        wisc_hazard_set(wisc_file,0,hazard_set_file,20);
    else
...
hazard_set_file=[climada_global.hazards_dir filesep 'WISC_eur_WS.mat'];
if ~exist(hazard_set_file,'file')
    load([climada_global.hazards_dir filesep 'WISC_eraint_eur_WS.mat']); % load second hazard first, since larger
    hazard_eraint=hazard;clear hazard
    load([climada_global.hazards_dir filesep 'WISC_era20c_eur_WS.mat']); % load first hazard
...
ssi_filename=[climada_global.results_dir filesep 'WISC_eur_WS_ssi.mat'];
...
stats_filename=[climada_global.results_dir filesep 'WISC_eur_WS_stats.mat'];
...
hazard=rmfield(hazard,'stats'); % to be on the safe side
...
load([climada_global.results_dir filesep 'WISC_eur_WS_ssi.mat']);
...
saveas(fig_ssi,[climada_global.results_dir filesep 'WISC_eur_WS_ssi'],'png');delete(fig_ssi); % save and delete figure

% plot hazard return period maps
load([climada_global.results_dir filesep 'WISC_eur_WS_stats.mat']);
...
saveas(fig_stats,[climada_global.results_dir filesep 'WISC_eur_WS_stats_hist'],'png');delete(fig_stats); % save and delete figure
...
saveas(fig_stats,[climada_global.results_dir filesep 'WISC_eur_WS_stats'],'png');delete(fig_stats); % save and delete figure
